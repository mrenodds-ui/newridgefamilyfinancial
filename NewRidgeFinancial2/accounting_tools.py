"""Single-source chart of accounts and journal draft templates for NR2 desktop."""
...
def infer_transaction_type(description: str, context: dict[str, object]) -> str:
...
def draft_journal_entry_for_common_case(
    *,
    ...
    transaction_type = infer_transaction_type(description, context)
