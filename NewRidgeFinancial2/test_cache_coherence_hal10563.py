"""Moonshot cache coherence (hal-10569) — stub fill failure + BUILD_ID."""
...
class CacheCoherenceTests(unittest.TestCase):
    ...
    def test_build_id(self) -> None:
        self.assertEqual(BUILD_ID, "hal-10569")
    ...
    def test_stub_then_fill_success(self) -> None:
        ...
        self.assertEqual(full.get("buildId"), "hal-10569")
    ...
    def test_fill_failure_surfaces_non_warming_payload(self) -> None:
        ...
        try:
            ...
            self.assertEqual(hit.get("buildId"), "hal-10569")
