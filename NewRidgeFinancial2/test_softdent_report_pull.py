...
class SoftDentReportPullTests(unittest.TestCase):
    ...
    def test_select_file_name_uses_softdent_report_exports(self):
        from softdent_report_pull import SOFTDENT_SELECT_FILE_PATH_HYGIENE

        self.assertIn(r"C:\SoftDentReportExports", SOFTDENT_SELECT_FILE_PATH_HYGIENE)
        self.assertIn("Select File Name", SOFTDENT_SELECT_FILE_PATH_HYGIENE)
        self.assertIn("softdentexportreports", SOFTDENT_SELECT_FILE_PATH_HYGIENE)
        steps = " ".join(universal_report_pull_steps())
        self.assertIn(r"C:\SoftDentReportExports", steps)
        self.assertNotIn("NEVER type SoftDentReportExports", steps)
    ...
    def test_hal_reply_teaches_pull(self):
        ...
        self.assertNotIn("NEVER type SoftDentReportExports", text)
