...
if (Test-Path ./dashboard-frontend/package.json) {
    Invoke-Step "Dashboard-frontend: npm install" "npm install" "./dashboard-frontend"
    Invoke-Step "Dashboard-frontend: lint" "npm run lint" "./dashboard-frontend"
    Invoke-Step "Dashboard-frontend: typecheck" "npm run typecheck" "./dashboard-frontend"
    Invoke-Step "Dashboard-frontend: test" "npm test -- --verbose" "./dashboard-frontend"
}
